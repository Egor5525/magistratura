...
image1 = cv.imread('./bloodcells.png')
image2 = cv.imread('./chlorella.png')
...
<figure>
<center>
<img src='https://drive.google.com/uc?id=1Fn2PqTWnVuun3c2VSHTiouDwiPpoFwWJ' />
<figcaption> Пример сегментации</figcaption></center>
</figure>
